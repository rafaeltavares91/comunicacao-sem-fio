...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonConectar->setMaximumSize(QSize(16777215, 16777215));

        verticalLayout->addWidget(pushButtonConectar);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindow", "Escanear", 0));
